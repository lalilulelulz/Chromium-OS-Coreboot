...
const ww_ring_state_prog wwr_state_programs[] = {
	/*
...
/* NOTE:
 * Arkham has only one controller. No external triggers in case of Arkham
 */
...
/* Rgb set to 128, resulting in a brightish white color. */
static const uint8_t arkham_led_solid_808080_text[] = {
	0x01, 0x00, 0x00, 0x10, 0x00, 0x20, 0x9F, 0x80,
	0x40,  128, 0xC0, 0x00, 0x9F, 0x81, 0x40,  128,
	0xC0, 0x00, 0x9F, 0x82, 0x40,  128, 0xC0, 0x00
};

static const TiLp55231Program arkham_led_solid_808080_program = {
	arkham_led_solid_808080_text,
	sizeof(arkham_led_solid_808080_text),
	0,
	{ 3, 6, 9 }
};
...
*/
static const uint8_t arkham_led_blink_wipeout1_text[] = {
...
static const uint8_t arkham_led_blink_wipeout2_text[] = {
	0x01,  0x00,  0x00,  0x10,  0x00,  0x20,  0x90,   255,
	0x94,    80,  0x98,     0,  0x9f,  0x80,  0x84,  0x60,
...
static const TiLp55231Program arkham_led_blink_wipeout1_program = {
	arkham_led_blink_wipeout1_text,
	sizeof(arkham_led_blink_wipeout1_text),
	0,
	{ 3,  24,  25,  }
};
static const TiLp55231Program arkham_led_blink_wipeout2_program = {
	arkham_led_blink_wipeout2_text,
	sizeof(arkham_led_blink_wipeout2_text),
	0,
	{ 3,  22,  23,  }
};

static const uint8_t arkham_led_blink_recovery1_text[] = {
	0x01,  0x00,  0x00,  0x10,  0x00,  0x20,  0x90,  0x02,
	0x94,  0x02,  0x9f,  0x80,  0x98,   255,  0x84,  0x62,
...
static const TiLp55231Program arkham_led_blink_recovery1_program = {
	arkham_led_blink_recovery1_text,
	sizeof(arkham_led_blink_recovery1_text),
	0,
	{ 3,  24,  25,  }
};
static const uint8_t arkham_led_blink_recovery2_text[] = {
	0x01,  0x00,  0x00,  0x10,  0x00,  0x20,  0x90,   255,
...
static const TiLp55231Program arkham_led_blink_recovery2_program = {
	arkham_led_blink_recovery2_text,
	sizeof(arkham_led_blink_recovery2_text),
	0,
	{ 3,  22,  23,  }
};
...
static const uint8_t arkham_led_fade_in1_text[] = {
	0x01,  0x00,  0x00,  0x10,  0x00,  0x20,  0x9f,  0x80,
	0x40,  0x00,  0xe0,  0x0c,  0xc0,  0x00,  0x9f,  0x81,
	0x40,  0x00,  0xe0,  0x80,  0x42,  0x57,  0xc0,  0x00,
	0x9f,  0x82,  0x40,  0x00,  0xe0,  0x80,  0x34,  0x9b,
	0xc0,  0x00,  0x00,
};
static const TiLp55231Program arkham_led_fade_in1_program = {
	arkham_led_fade_in1_text,
	sizeof(arkham_led_fade_in1_text),
	0,
	{ 3,  7,  12,  }
};

static const uint8_t arkham_led_fade_in2_text[] = {
	0x01,  0x00,  0x00,  0x10,  0x00,  0x20,  0x9f,  0x80,
	0x40,  0x00,  0xe0,  0x0c,  0xc0,  0x00,  0x9f,  0x81,
	0x40,  0x00,  0xe0,  0x80,  0x42,  0x57,  0xc0,  0x00,
	0x9f,  0x82,  0x40,  0x00,  0xe0,  0x80,  0x34,  0x9b,
...
static const TiLp55231Program arkham_led_fade_in2_program = {
	arkham_led_fade_in2_text,
	sizeof(arkham_led_fade_in2_text),
	0,
	{ 3,  7,  12,  }
};

const ww_ring_state_prog arkham_led_state_programs[] = {
	/*
	 * for test purposes the blank screen program is set to blinking, will
	 * be changed soon.
	 */
	{WWR_ALL_OFF, {&arkham_led_solid_000000_program,
				   &arkham_led_solid_000000_program} },
	{WWR_RECOVERY_PUSHED, {&arkham_led_solid_808080_program,
					   &arkham_led_solid_808080_program} },
	{WWR_WIPEOUT_REQUEST, {&arkham_led_blink_wipeout1_program,
			       &arkham_led_blink_wipeout2_program} },
	{WWR_RECOVERY_REQUEST, {&arkham_led_blink_recovery1_program,
				&arkham_led_blink_recovery2_program} },
	{WWR_NORMAL_BOOT, {&arkham_led_fade_in1_program,
				       &arkham_led_fade_in2_program} },
	{}, /* Empty record to mark the end of the table. */
};
