...
Device (BATX)
{
	...
	Method (_BIF, 0, Serialized)
	{
		...
		Store (SWAB (BDC0), Index (PBIF, 1)) // Batt Design Capacity
		Store (SWAB (BFC0), Index (PBIF, 2)) // Batt Last Full Charge Capacity
		Store (SWAB (BDV0), Index (PBIF, 4)) // Batt Design Voltage
		//Store (SWAB (BAL0), Index (PBIF, 6))
