...
const struct reg_script_bus_entry * __attribute__((weak)) platform_bus_table(size_t *table_entries)
{
...
static const struct reg_script_bus_entry *find_bus(const struct reg_script *step)
{
