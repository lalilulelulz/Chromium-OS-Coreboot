...
Method(_PRT)
{
	If (PICM) {
		Return (Package() {
			...
			Package() { 0x001cffff, 0, 0, 19 },//  D28IP_P1IP  WLAN   INTB -> PIRQC
			Package() { 0x001cffff, 1, 0, 21 },//  D28IP_P2IP  ETH0   INTA -> PIRQB
			Package() { 0x001cffff, 2, 0, 17 },//  D28IP_P3IP  SDCARD INTC -> PIRQD
