...
/* GSPI0_CS# */		PAD_CFG_GPI_ACPI_SCI(GPP_B15, NONE, DEEP, NO), /* DIG EJECT */
...
/* UART0_RXD */		PAD_CFG_GPI_APIC(GPP_C8, NONE, PLTRST), /* DIG IRQ */
/* UART0_TXD */		PAD_CFG_GPI_APIC(GPP_C9, NONE, PLTRST), /* DIG DETECT */
/* UART0_RTS# */	PAD_CFG_GPI_ACPI_SCI(GPP_C10, NONE, DEEP, YES), /* DIG EJECT but can't because GPP routing rescriptions to PM */
...
/* TS_SPI1_IO3 */	PAD_CFG_GPO(GPP_D22, 0, DEEP), /* I2S2 BUFFER */
