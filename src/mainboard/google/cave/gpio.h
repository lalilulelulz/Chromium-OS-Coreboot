...
/* PIRQA# */		PAD_CFG_GPO(GPP_A7, 0, DEEP),
...
/* SD_1P8_SEL */	PAD_CFG_GPO(GPP_A16, 0, DEEP),
/* SD_PWR_EN# */	PAD_CFG_GPO(GPP_A17, 3, DEEP),
/* ISH_GP0 */		PAD_CFG_GPO(GPP_A18, 3, DEEP),
/* ISH_GP1 */		PAD_CFG_NC(GPP_A19),
/* ISH_GP2 */		PAD_CFG_GPO(GPP_A20, 3, DEEP),
/* ISH_GP3 */		PAD_CFG_GPO(GPP_A21, 3, DEEP),
/* ISH_GP4 */		PAD_CFG_GPO(GPP_A22, 3, DEEP),
...
/* SPKR */		PAD_CFG_GPO(GPP_B14, 1, DEEP),
...
/* SM1ALERT# */		PAD_CFG_GPI(GPP_B23, 20K_PD, DEEP),
...
/* SML0ALERT# */	PAD_CFG_GPO(GPP_C5, 1, DEEP),
/* SM1CLK */		PAD_CFG_GPI(GPP_C6, NONE, DEEP), /* EC_IN_RW */
...
/* UART2_RTS# */	PAD_CFG_GPO(GPP_C22, 0, DEEP), /* EN_PP3300_DX_TOUCH */
/* UART2_CTS# */	PAD_CFG_GPI(GPP_C23, NONE, DEEP), /* PCH_WP */
...
/* ISH_I2C0_SDA */	PAD_CFG_GPO(GPP_D5, 0, DEEP), /* EN_PP3300_DX_EMMC */
/* ISH_I2C0_SCL */	PAD_CFG_GPO(GPP_D6, 0, DEEP), /* EN_PP1800_DX_EMMC */
/* ISH_I2C1_SDA */	PAD_CFG_NF(GPP_D7, NONE, DEEP, NF1),
/* ISH_I2C1_SCL */	PAD_CFG_NF(GPP_D8, NONE, DEEP, NF1),
			PAD_CFG_NC(GPP_D9),
			PAD_CFG_NC(GPP_D10),
			PAD_CFG_NC(GPP_D11),
			PAD_CFG_GPO(GPP_D12, 0, DEEP), /* EN_PP3300_DX_CAM */
...
/* SATA_DEVSLP0 */	PAD_CFG_NF(GPP_E4, NONE, DEEP, NF1), /* TOUCH_RESET */
...
/* DDPB_HPD0 */		PAD_CFG_GPI(GPP_E13, NONE, DEEP),
/* DDPC_HPD1 */		PAD_CFG_GPI(GPP_E14, NONE, DEEP),
