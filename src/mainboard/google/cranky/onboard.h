...
#define CRANKY_NIC_VENDOR_ID			0x10EC
#define CRANKY_NIC_DEVICE_ID			0x8168

/* 0x00: White LINK LED and Amber ACTIVE LED */
#define CRANKY_NIC_LED_MODE				0x00
...
#define BOARD_TOUCHSCREEN_I2C_ADDR      0x10    /* TODO(shawnn): Check this */
