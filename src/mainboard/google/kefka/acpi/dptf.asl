...
Name (DTRT, Package () {
	...
	Package () { \_SB.PCI0.B0DB, \_SB.PCI0.B0DB, 100, 30, 0, 0, 0, 0 },

	/* CPU Effect on Temp Sensor 0 */
	Package () { \_SB.PCI0.B0DB, \_SB.DPTF.TSR0, 100, 30, 0, 0, 0, 0 },
	...
	Package () { \_SB.PCI0.B0DB, \_SB.DPTF.TSR1, 100, 30, 0, 0, 0, 0 },

	/* CPU Effect on Temp Sensor 2 */
	Package () { \_SB.PCI0.B0DB, \_SB.DPTF.TSR2, 100, 30, 0, 0, 0, 0 },
})
