...
static void pch_enable_lpc(void)
{
	...
	/* Here is an excellent example of why we need the device tree in romstage:
	 * This is known to devicetree.cb. If you change that, change this:
	 */
	/* Map 256 bytes at I/O 0x800 to LPC */
	pci_write_config32(PCH_LPC_DEV, LPC_GEN1_DEC, 0x00fc0801);
	/* Map 256 bytes at I/O 0x900 to LPC */
	pci_write_config32(PCH_LPC_DEV, LPC_GEN2_DEC, 0x00fc0901);
}
