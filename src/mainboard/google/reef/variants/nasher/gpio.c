...
static const struct pad_config gpio_table[] = {
	...
	PAD_NC(GPIO_126, UP_20K), /* unused */
	PAD_NC(GPIO_127, UP_20K), /* unused */
	...
	PAD_NC(GPIO_134, UP_20K), /* unused */
	PAD_NC(GPIO_135, UP_20K), /* unused */
	...
	PAD_NC(GPIO_90, UP_20K),	/* unused */
	PAD_NC(GPIO_91, UP_20K),	/* unused */
	...
	PAD_NC(GPIO_106, UP_20K),	/* unused */

	/* SIO_SPI_0 - Used for FP */
	PAD_NC(GPIO_104, UP_20K),			/* unused */
	PAD_NC(GPIO_105, UP_20K),			/* unused */
	PAD_NC(GPIO_109, UP_20K),			/* unused */
	PAD_NC(GPIO_110, UP_20K),			/* unused */
	...
	PAD_CFG_GPI(GPIO_3, DN_20K, DEEP),	 /* FP_INT */
	...
	PAD_NC(GPIO_13, UP_20K), /* unused */
	PAD_NC(GPIO_14, UP_20K), /* unused */
